...
zpool.create = function (pool, config, force, callback) {
    ...
    return zpool._create(pool, config, force, null, callback);
}

zpool.rcreate = function (pool, config, force, altroot, callback) {
    if (arguments.length !== 5) {
        throw Error('Invalid arguments, 5 arguments required');
    }
    return zpool._create(pool, config, force, altroot, callback);
}

zpool._create = function (pool, config, force, altroot, callback) {
    var args;
...
zpool.efi_create = function (pool, config, force, altroot, callback) {
    var args;
